...
import './images/annual_filing.png'
import './images/quarterly_filing.png'
...
const links = {
  ...
  2019: [
    ...
    <li key="4"><Link to="/2019/annual-filing-dates/">Annual HMDA Filing Period Dates</Link></li>
  ],
  2020: [
    ...
    <li key="7"><Link to="/2020/annual-filing-dates/">Annual HMDA Filing Period Dates</Link></li>,
    <li key="8"><Link to="/2020/quarterly-filing-dates/">Quarterly HMDA Filing Period Dates</Link></li>
